<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="DefaultPage.aspx.cs" Inherits="HomePage" %>
...
<div id="accessibility-options">
  ...
  <!-- Contact Section -->
  <div class="w3-container w3-padding-64" id="contact" style="background-color: #eaeaea; height: 500px;"; ">
    <h1 class="auto-style19" >יצירת קשר</h1><br>
    <p class="auto-style19">לקבלת שיחת ייעוץ, מלא את הפרטים הבאים :</p>
    <form action="HomePage.aspx" id="form2" method="post" runat="server"  onsubmit="return ValidateForm()">
...
<asp:Button runat="server" ID="btnSubmit" Text="שלחו פרטים" OnClick="btnSubmit_Click" class="w3-button w3-light-grey w3-section" />
    </form>
  </div>
